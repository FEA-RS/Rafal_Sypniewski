...
\[Discretized model\](images/discrete\_model.png)
...
!\[Steady\-state temperature distribution\](images/thermal\_results.png)
...
!\[Temperature distribution comparison from Ansys\](images/ansys\_verification.png)
